...
echo "isCreated: ".var_export($host->isCreated(), true);
echo "\n";

echo "\n";

$hostPersonal = new HostingPersonal('test.com', 'testcom', 'aexxxxxx@xxxxxxxx.com', true);
echo "Creating HostingPersonal\n";
if($hostPersonal->create()) {
    echo "Hosting 'Personal' created in ".Hosting::HOME."\n";
}
echo "isCreated: ".var_export($hostPersonal->isCreated(), true);
echo "\n";
